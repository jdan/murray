...
comment = function(text, like_count) {
    return '<li class="uiUfiComment ufiItem ufiItem">                                                                               \
        <div class="UIImageBlock clearfix uiUfiActorBlock">                                                                         \
            <a class="actorPic UIImageBlock_Image UIImageBlock_SMALL_Image"                                                         \
                href="https://www.facebook.com/pages/Bill-Murray/40950792955" tabindex="-1">                                        \
                <img class="uiProfilePhoto uiProfilePhotoMedium -cx-PRIVATE-uiSquareImage__medium img" src=' + IMG_SRC + ' alt="">  \
            </a>                                                                                                                    \
            <div class="commentContent UIImageBlock_Content UIImageBlock_SMALL_Content">                                            \
              <a class="actorName" href="https://www.facebook.com/pages/Bill-Murray/40950792955">Bill Murray</a>                    \
